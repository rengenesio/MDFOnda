#############################################################################
# Makefile for building: MDFonda
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Sep 23 03:36:46 2013
# Project:  MDFonda.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -lglut -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/main.cpp \
		...
		src/Vector.cpp \
		src/Point.cpp \
		src/Color.cpp moc_MainWindow.cpp \
		moc_GLDisplay.cpp \
		moc_Arcball.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/MDFonda1.0.0/ && $(COPY_FILE) --parents src/MainWindow.h src/GLDisplay.h src/Arcball.h src/RenderController.h src/Object3D.h src/DirectionalLight.h src/Scene3D.h src/Wave.h src/Vector.h src/Point.h src/Color.h src/UIMainWindow.h .tmp/MDFonda1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/MainWindow.cpp src/GLDisplay.cpp src/Arcball.cpp src/RenderController.cpp src/Object3D.cpp src/DirectionalLight.cpp src/Scene3D.cpp src/Wave.cpp src/Vector.cpp src/Point.cpp src/Color.cpp .tmp/MDFonda1.0.0/ && (cd `dirname .tmp/MDFonda1.0.0` && $(TAR) MDFonda1.0.0.tar MDFonda1.0.0 && $(COMPRESS) MDFonda1.0.0.tar) && $(MOVE) `dirname .tmp/MDFonda1.0.0`/MDFonda1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/MDFonda1.0.0
